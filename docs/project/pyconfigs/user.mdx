...
```python models/federates/fed_sales.py
from squirrels import arguments as args
import polars as pl
...
- [context.py] - How to use user fields in context variables
...
[context.py]: /project/pyconfigs/context
[parameters.py]: /project/pyconfigs/parameters

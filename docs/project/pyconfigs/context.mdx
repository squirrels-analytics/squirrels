...
```sql models/federates/fed_sales_report.sql
SELECT 
...
```python models/federates/fed_sales_report.py
from squirrels import arguments as args
import polars as pl
...
```python models/federates/fed_model.py
...
```sql models/federates/fed_model.sql

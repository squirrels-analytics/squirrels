...
import { minorVersion } from '/snippets/variables.mdx';
...
Ensure this displays a version that starts with {minorVersion}.
...
This provides input prompts for you to answer before the project is set up. Command line options can also be used in place of prompts. See the `sqrl new` command reference for more details.
...
- Learn more about creating your own Squirrels project by following [this tutorial](/start/tutorial)

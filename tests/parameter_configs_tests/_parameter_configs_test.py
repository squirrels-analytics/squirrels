...
class TestMultiSelectParameterConfig:
    def test_with_selection1(
        self, user: User, ms_param_basic: p.MultiSelectParameter, ms_config_basic: _pc.MultiSelectParameterConfig
    ):
    ...
    def test_with_selection3(
        self, user: User, ms_param_basic: p.MultiSelectParameter, ms_config_with_ms_parent: _pc.MultiSelectParameterConfig
    ):
    ...
    def test_with_selection4(
        self, user: User, ss_param_with_ms_parent: p.SingleSelectParameter, ms_config_with_ss_parent: _pc.MultiSelectParameterConfig
    ):
...
class TestSingleSelectParameterConfig:
    ...
    def test_with_selection3(
        self, user: User, ss_param_with_ms_parent: p.SingleSelectParameter, ss_config_with_ss_parent: _pc.SingleSelectParameterConfig
    ):
...
class TestDateParameterConfig:
    def test_with_selection1(
        self, user: User, ss_param_with_ms_parent: p.SingleSelectParameter, date_config_with_parent: _pc.DateParameterConfig
    ):
...
class TestDateRangeParameterConfig:
    def test_with_selection1(self, user: User, date_range_config: _pc.DateRangeParameterConfig):
...
class TestNumberRangeParameterConfig:
    def test_with_selection1(self, user: User, num_range_config: _pc.NumberRangeParameterConfig):

...
from squirrels import _parameter_options as po, _utils as u
...
def test_invalid_date_parameter_options():
    ...
    with pytest.raises(u.ConfigurationError):
        po.DateParameterOption('2021-01-01', min_date='2022-01-01')
    with pytest.raises(u.ConfigurationError):
        po.DateParameterOption('2023-01-01', max_date='2022-01-01')
    with pytest.raises(u.ConfigurationError):
        po.DateRangeParameterOption('2022-01-01', '2024-01-01', min_date='2023-01-01')
    with pytest.raises(u.ConfigurationError):
        po.DateRangeParameterOption('2022-01-01', '2024-01-01', max_date='2023-01-01')

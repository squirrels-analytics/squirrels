...
class TestMultiSelectParameterConfig:
    def test_with_selection1(
        self, user: a.BaseUser, ms_param_basic: p.MultiSelectParameter, ms_config_basic: pc.MultiSelectParameterConfig
    ):
    ...
    def test_with_selection3(
        self, user: a.BaseUser, ms_param_basic: p.MultiSelectParameter, ms_config_with_ms_parent: pc.MultiSelectParameterConfig
    ):
    ...
    def test_with_selection4(
        self, user: a.BaseUser, ss_param_with_ms_parent: p.SingleSelectParameter, ms_config_with_ss_parent: pc.MultiSelectParameterConfig
    ):
...
class TestSingleSelectParameterConfig:
    ...
    def test_with_selection3(
        self, user: a.BaseUser, ss_param_with_ms_parent: p.SingleSelectParameter, ss_config_with_ss_parent: pc.SingleSelectParameterConfig
    ):
    ...
    def test_invalid_with_selection(
        self, user: a.BaseUser, ms_param_basic: p.MultiSelectParameter, ss_config_with_ms_parent: pc.SingleSelectParameterConfig
    ):
        with pytest.raises(InvalidInputErrorTmp):
...
class TestDateParameterConfig:
    def test_with_selection1(
        self, user: a.BaseUser, ss_param_with_ms_parent: p.SingleSelectParameter, date_config_with_parent: pc.DateParameterConfig
    ):
...
class TestDateRangeParameterConfig:
    def test_with_selection1(self, user: a.BaseUser, date_range_config: pc.DateRangeParameterConfig):
...
class TestNumberRangeParameterConfig:
    def test_with_selection1(self, user: a.BaseUser, num_range_config: pc.NumberRangeParameterConfig):
